...
async function sendToServer(data) {
    try {
        const response = await fetch("http://localhost/restaurant/connect.php", {
            method: "POST",
    ...
    const UsersList=Users.map((user)=>{
        ...
        return <div key={user.id}><p>hello {Inputs.visiteur} your total price is {user.prix*user.daysnumber} DH</p></div>
    })
